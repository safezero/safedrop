...
const hashcash = require('safedrop-hashcash')

const SafedropClient = module.exports = defunction(['Keypair', 'Uint8Array', 'Gateway'], '*', function SafedropClient(identityKeypair, memoryRootKey, gateway) {
...
SafedropClient.prototype.send = defunction(['Gateway', 'Uint8Array'], 'Promise', function send(gateway, message) {
  return this.gatewayConnectionsManager.get(gateway).send(message)
})

SafedropClient.prototype.sendCommandEncoding = defunction(['Gateway', 'Uint8Array'], 'Promise', function sendCommandEncoding(gateway, commandEncoding) {
...
SafedropClient.prototype.addDrop = defunction(['Persona', 'Uint8Array'], '=>Uint8Array', function addDrop(persona, drop) {
...
SafedropClient.prototype.getDrops = defunction([], '=>[]Uint8Array', function getDrops() {
  const commandEncoding = commandTemplate.encode({
    branch: 'getDrops',
...
SafedropClient.prototype.addPlaintext = defunction(['Persona', 'Uint8Array'], 'Promise', function addPlaintext(persona, plaintext) {
...
SafedropClient.prototype.getCryptixes = defunction([], '=>[]Cryptix', function getCryptixes() {
...
SafedropClient.prototype.getCryptixPayloads = defunction([], '=>[]*', function getCryptixPayloads() {
...
SafedropClient.prototype.getCryptixPayloadPlaintexts = defunction([], '=>[]Uint8Array', function getCryptixPayloadPlaintexts() {
